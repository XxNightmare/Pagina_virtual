        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="buscar_animales.php">Buscar animales</a></li>
                    <li><a href="eliminar_animal.php" class="active">Eliminar animales</a></li>
    ...
    <main id="main">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $query = "SELECT id, nombre, raza, tamano, sexo, padecimiento FROM animales";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<tr><td colspan='7'>No se encontraron animales.</td></tr>";
                }
